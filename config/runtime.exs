...
#
#     PHX_SERVER=true bin/rlm start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :rlm, RLMWeb.Endpoint, server: true
end

config :rlm, RLMWeb.Endpoint, http: [port: String.to_integer(System.get_env("PORT", "4000"))]
...
if config_env() == :prod do
  ...
  config :rlm, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
